...
def next_ascent_hill_climbing(coil_t, coil_r, r_turn, d):
    # mutation counter
    all_mutation = 0
    good_mutation = 0
    bad_mutation = 0
    ...
    while np.abs(fit_kq - fit_k) > thr and i != limit:
        ...
        for ind in range(1, len(coil_tq) - 1):
            ...
            # mutate sequentially all internal turns in the transmitting coil
...
def launch(iterations, coil_t, coil_r, r_turn, d):
    ...
    for _ in range(iterations):
        ...
        coil, k, allm, badm, goodm = next_ascent_hill_climbing(
            coil_t=coil_t,
            coil_r=coil_r,
            r_turn=r_turn,
            d=d
...
def main():
    ...
    ------------------------------------------------------------
    '''
    # coil_t, k, allm, badm, goodm = next_ascent_hill_climbing(
    #     coil_t=coil_t,
    #     coil_r=coil_r,
    #     r_turn=r_turn,
    #     d=d
